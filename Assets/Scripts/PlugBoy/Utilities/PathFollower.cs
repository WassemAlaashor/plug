...
namespace PlugBoy.Utilities
{
    ...
    public class PathFollower : MonoBehaviour
    {
		...
		[SerializeField]
		protected Outlet m_SwitchOutlet; // Activates the movement when a plug is connected
        [SerializeField]
        ...
        protected bool m_Enabled = true; // TODO
        ...
        void Update()
        {
			...
			if (m_SwitchOutlet)
			{
				m_Stopped = !m_SwitchOutlet.PlugConnected;
			}

            if (m_CurrentPoint == null || m_CurrentPoint.Current == null || !m_Enabled || m_Stopped || !GameManager.Singleton.gameRunning)
            {
                return;
            }
